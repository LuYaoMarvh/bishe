...
显示出返回sql查询后结果，是大模型处理组织过后的自然语言回答
"""
import sys
...
def answer_builder_node(state: NL2SQLState) -> NL2SQLState:
    ...
    Converts SQL results to natural language with conclusion, key values, and SQL provenance.
    Also handles chat responses (non-SQL queries).
